...
# TODO: replace lexer with a PEG
# HACK: this is all copy-pasted, in order to speed up `piga` development,
#   as it'll be used as a replacement
module Lex
...
module Lex
  ...
  class Lexer
    ...
    def error msg = nil
      raise Lex::Error, "error at line #{@token.line}, " \
...
module Piga
  module Grammar
    ...
    class OldParser < Piga::Parser
      ...
      def parse
        skip(:NEWLINE)
        Piga::Grammar::AST::Grammar.new [], grammar
      end
